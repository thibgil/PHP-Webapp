...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='LegalTerms.css'>
    <link rel="icon" type="image/png" href="../img/factorypng.png">
    <script src='LegalTerms.js'></script>
</head>
<body>
        ...
        <nav class="menuNav">
            ...
            <div class="leftSide">
                ...
                <form action="../Config/languages.includes.php" method="post">
                    ...
                    <input type="hidden" name="URL" id="URL" value="Legalterms/LegalTerms.php">
    ...
    <div class="content">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Infinite Measures, 10 rue de Vanves, 92130 Issy-les-Moulineaux.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Infinite Measures, accessible from <a href="../../index.php" rel="external nofollow noopener" target="_blank">http://www.infinitemeasures.com</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By visiting this page on our website: <a href="../../index.php" rel="external nofollow noopener" target="_blank">http://www.infinitemeasures/contact</a></li>
        </ul>
    </div>
    ...
    <footer class="footer">
        <ul>
            <li class="link">
                <a href="../LegalTerms/LegalTerms.php" style='text-decoration:underline'>Legal Terms</a>
            </li>
        </ul>
